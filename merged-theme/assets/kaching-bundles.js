import { s as b, a as F, g as Z, d as h, i as w, e as O, F as ct, b as M, c as D, f as S, q as B, h as q, j as we, w as ie, k as C, l as ve, o as dt, m as tt, n as L, p as G, r as Ie, t as Se, u as Pe, v as K, x as $, y as Ae, z as Be, A as Te, B as Ee, C as De, D as qe, E as Fe, G as Ne, H as Me, I as Oe } from "./kaching-bundles-api.js";
const Le = () => {
...
`, X = async (i, {
  ...
  if (l) {
    ...
    for (const P of _)
      P.status === "fulfilled" ? g.push(P.value) : l(
    ...
    const y = p.optionValues.map((k) => {
      ...
      return {
        ...
        swatch: {
          ...
          image: ((P = (g = (_ = k.swatch) == null ? void 0 : _.image) == null ? void 0 : g.previewImage) == null ? void 0 : P.url) || null
        }
      };
    });
    return {
...
class ei {
  ...
  _findBundleItems(t) {
    ...
    return h("No matching items found for deal", { dealId: n }), e && this._reportPassthrough(e, "no_matching_deal", n), null;
  }
  ...
  // telemetry at all.
  _reportPassthrough(t, e, n) {
    var r;
    try {
      const a = JSON.parse(
        t.properties.__kaching_bundles
      );
      b("intercept_cart_request_passthrough_v1", {
        reason: e,
        deal: n,
        hasBar: !!((r = a.bar) != null ? r : a.bid)
      });
    } catch (a) {
      console.error(a);
    }
...
class Pi {
  ...
  _handleNativeVariantChange(t) {
    if (h("handleNativeVariantChange", {
      ...
      ), S(this._dealBlockElement, "current-variant-source", "native"), S(
        this._dealBlockElement,
        "current-variant-id",
        String(t)
      );
  ...
  _changeCurrentVariant(t) {
    ...
    if (h("_changeCurrentVariant", {
      ...
      return;
    this._globalConfig.featureFlags.propagate_picker_option_changes && (S(this._dealBlockElement, "current-variant-source", "bar"), S(
      this._dealBlockElement,
      "current-variant-id",
      String(t)
    ));
  ...
  _listenForAddToCartClick() {
    ...
    t.setValidation(() => {
      ...
      if (this._refreshItemsBeforeAddToCart(), this._globalConfig.featureFlags.intercept_cart_request)
        if (this._items.some((a) => a.properties.__kaching_bundles)) {
...
function ht(i) {
  var e;
  ((e = i.getAttribute(Jt)) != null ? e : at) !== N && S(i, Jt, N);
}
function qi() {
  if (Kt)
    return;
...
class te {
  ...
  async _fetchPlaceholdersData(t) {
    ...
    for (const g of t) {
      const P = Number(g.getAttribute("product-id")), T = m.get(P);
      if (!T)
        continue;
      const vt = ((v = s.get(P)) == null ? void 0 : v.filter((I) => I)) || f;
      vt.sort((I, E) => {
        const It = !!I.marketId, Ce = !!E.marketId;
        return It === Ce ? 0 : It ? -1 : 1;
      });
      let A = je(vt, T);
      h("applicableDealBlocks", A), A = A.filter((I) => I.marketId ? I.marketId === this._globalConfig.marketId : !0), A = A.filter(
        (I) => {
          var E;
          return !((E = I.excludedMarketIds) != null && E.includes(this._globalConfig.marketId));
        }
      ), A = A.filter((I) => {
        ...
        return I.abTestVariantNumber === E;
      }), this._globalConfig.b2bCustomer && (A = A.filter(
